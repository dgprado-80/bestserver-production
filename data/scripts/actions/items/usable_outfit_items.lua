local outfitConfig = {
	...
	-- revenant
	[34075] = { female = 1323, male = 1322, addon = 1, orangeText = "Now the beast is unleashed!" },
	[34076] = { female = 1323, male = 1322, addon = 2, orangeText = "Wild power flows though your body!" },
	...
	-- rootwalker
	[48514] = { female = 1775, male = 1774, addon = 1, orangeText = "You receive the first Rootwalker addon" },
	[48515] = { female = 1775, male = 1774, addon = 2, orangeText = "You receive the second Rootwalker addon" },
