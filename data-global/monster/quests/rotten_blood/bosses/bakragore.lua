...
monster.loot = {
  { name = "crystal coin", chance = 19075, maxCount = 125 },
    ...
    { name = "darklight figurine", chance = 875, maxCount = 1 },
    { name = "the essence of vemiath", chance = 575, maxCount = 1 },
	{ id = 43895, chance = 900 }, -- bag you covet
	{ id = 43897, chance = 250 } -- bag you covet grans
}
