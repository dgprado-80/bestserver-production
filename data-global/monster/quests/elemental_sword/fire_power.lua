local mType = Game.createMonsterType("Fire Power")
local monster = {}

monster.description = "Fire Power"
...
monster.attacks = {
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = -500, maxDamage = -5500, length = 8, spread = 0, effect = CONST_ME_WHITE_ENERGY_SPARK },
	{ name = "combat", interval = 2000, chance = 15, type = COMBAT_ICEDAMAGE, minDamage = -1000, maxDamage = -6000, effect = CONST_ME_ICEATTACK },
