...
monster.summon = {
	maxSummons = 5,
	summons = {
		{ name = "Demon", chance = 12, interval = 3000, count = 5 },
	},
}
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_MANADRAIN, minDamage = -800, maxDamage = -3300, range = 7, effect = CONST_ME_MAGIC_RED, target = false },
	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_LIFEDRAIN, minDamage = -500, maxDamage = -1950, length = 8, spread = 0, effect = CONST_ME_HITBYPOISON, target = false },
	{ name = "combat", interval = 2000, chance = 21, type = COMBAT_LIFEDRAIN, minDamage = -450, maxDamage = -3000, radius = 6, effect = CONST_ME_POFF, target = false },
	-- poison
	...
	-- energy damage
	{ name = "condition", type = CONDITION_ENERGY, interval = 2000, chance = 18, minDamage = -600, maxDamage = -1400, radius = 6, effect = CONST_ME_ENERGYHIT, target = false },
	-- fire
...
monster.defenses = {
	...
	{ name = "combat", interval = 800, chance = 10, type = COMBAT_HEALING, minDamage = 600, maxDamage = 2000, effect = CONST_ME_MAGIC_GREEN, target = false },
