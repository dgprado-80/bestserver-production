...
{ name = "combat", interval = 2000, chance = 50, type = COMBAT_ENERGYDAMAGE, minDamage = -70, maxDamage = -180, range = 6, shootEffect = CONST_ANI_CHERRYBOMB, effect = CONST_ME_PURPLEENERGY, target = true },	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_ENERGYDAMAGE, minDamage = -170, maxDamage = -280, radius = 6, effect = CONST_ME_PURPLEENERGY, target = false },
