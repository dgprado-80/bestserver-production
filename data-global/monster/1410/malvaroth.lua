...
monster.description = "an malvaroth"
...
monster.outfit = {
	...
	monster.loot = {
		...
		{ id = 49893, chance = 500, maxCount = 1 }, -- Skin of Malvaroth
	...
	local aditionalMonsters = {
		...
		{ name = "Brinebrute Inferniarch", pos = Position(33778, 32390, 8) },
		{ name = "Brinebrute Inferniarch", pos = Position(33779, 32392, 8) },
		{ name = "Brinebrute Inferniarch", pos = Position(33778, 32394, 8) },
		{ name = "Brinebrute Inferniarch", pos = Position(33775, 32395, 8) },
		{ name = "Brinebrute Inferniarch", pos = Position(33777, 32394, 8) },
		{ name = "Brinebrute Inferniarch", pos = Position(33777, 32390, 8) },
	}

local areaTopLeft = Position(33772, 32385, 8) -- Esquina superior izquierda del área a verificar
local areaBottomRight = Position(33786, 32399, 8) -- Esquina inferior derecha del área a verificar
