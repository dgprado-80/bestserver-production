local mType = Game.createMonsterType("Dungeon Demon Hunter")
local monster = {}

monster.description = "an dungeon demon hunter"
...
monster.loot = {
	...
	{ name = "crystal coin", chance = 1760, maxCount = 5 },
	...
	{ name = "Draining Inferniarch Rod", chance = 60 },
	{ name = "Draining Inferniarch Wand", chance = 60 },
	{ name = "Draining Inferniarch Arbalest", chance = 60 },
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = -800, maxDamage = -2250, length = 8, effect = 249, target = false },
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -900, maxDamage = -2350, radius = 4, effect = 244, target = false },
