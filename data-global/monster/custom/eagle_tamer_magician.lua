local mType = Game.createMonsterType("Eagle Tamer Magician")
local monster = {}

monster.description = "a eagle tamer magician"
...
monster.loot = {
	...
	{ id = 3032, chance = 1810, maxCount = 2 }, -- small emerald
	{ name = "small enchanted ruby", chance = 9440, maxCount = 3 },
	{ id = 3030, chance = 1890, maxCount = 2 }, -- small ruby
	...
	{ id = 44648, chance = 100 }, -- mystical dragon robe
	{ id = 44649, chance = 100 }, -- mystical dragon robe
	{ id = 8043, chance = 2200 }, -- focus cape
	{ id = 21974, chance = 1400 }, -- golden lotus brooch
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_PHYSICALDAMAGE, minDamage = 0, maxDamage = -600, range = 4, shootEffect = CONST_ANI_INFERNALBOLT, target = true },
	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_PHYSICALDAMAGE, minDamage = 0, maxDamage = -400, radius = 4, effect = CONST_ME_ENERGYAREA, target = true },
	{ name = "melee", interval = 1200, chance = 100, minDamage = 0, maxDamage = -77 },
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_PHYSICALDAMAGE, minDamage = -50, maxDamage = -578, range = 7, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = false },
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_LIFEDRAIN, minDamage = -170, maxDamage = -1473, range = 7, effect = CONST_ME_MAGIC_RED, target = false },
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_MANADRAIN, minDamage = -59, maxDamage = -975, range = 7, effect = CONST_ME_MAGIC_RED, target = false },
