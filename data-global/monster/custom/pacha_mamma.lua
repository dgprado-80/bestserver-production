local mType = Game.createMonsterType("Pacha Mamma")
local monster = {}

monster.description = "a pacha mamma"
...
monster.loot = {
	...
	{ name = "crystal coin", chance = 4670, maxCount = 4 },
	...
	{ id = 44621, chance = 100 }, -- mystical dragon robe
	{ id = 44636, chance = 100 }, -- mystical dragon robe
	{ id = 44637, chance = 100 }, -- mystical dragon robe
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_FIREDAMAGE, minDamage = -66, maxDamage = -720, range = 7, radius = 4, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_GREEN_RINGS, target = true },
