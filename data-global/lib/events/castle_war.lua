local config = {
	...
	gate = {
		{position = Position(1337, 1279, 7), itemId = 11567},
	...
	positions = {
		...
		exitPosition = Position(1300, 1280, 6), -- Temple Position
	},
	throne = {
	...
	if next(playersCastle) ~= nil then
		for i = 1, #playersCastle do
			...
			if player then
				...
				player:sendTextMessage(MESSAGE_EVENT_ADVANCE, "[Castle War] The castle was closed and you were teleported to Thais.")
			end
		end
	end
