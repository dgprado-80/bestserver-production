...
local tiaraKeyword = keywordHandler:addKeyword({ "tiara" }, StdModule.say, { npcHandler = npcHandler, text = "Well... maybe, if you help me a little, I could convince the academy of Edron that you are a valuable help here and deserve an award too. How about it?" }, function(player)
	return player:getStorageValue(Storage.Quest.U7_8.MageAndSummonerOutfits.AddonHatCloak) == -1
end)
...
keywordHandler:addKeyword({ "tiara" }, StdModule.say, { npcHandler = npcHandler, text = "Before I can nominate you for an award, please complete your task" }, function(player)
	return player:getStorageValue(Storage.Quest.U7_8.MageAndSummonerOutfits.AddonHatCloak) > 0 and player:getStorageValue(Storage.Quest.U7_8.MageAndSummonerOutfits.AddonHatCloak) < 10
end)
keywordHandler:addAliasKeyword({ "award" })
...
local function addTaskKeyword(value, text)
	keywordHandler:addKeyword({ "task" }, StdModule.say, { npcHandler = npcHandler, text = text }, function(player)
		return player:getStorageValue(Storage.Quest.U7_8.MageAndSummonerOutfits.AddonHatCloak) == value
	end)
	if value == 10 then
...
local function addItemKeyword(keyword, text, value, itemId, count, last)
	...
	local rewardKeyword = itemKeyword:addChildKeyword({ "yes" }, StdModule.say, { npcHandler = npcHandler, text = text[2] }, nil, function(player)
		...
		player:setStorageValue(Storage.Quest.U7_8.MageAndSummonerOutfits.AddonHatCloak, player:getStorageValue(Storage.Quest.U7_8.MageAndSummonerOutfits.AddonHatCloak) + 1)
		player:setStorageValue(Storage.Quest.U7_8.MageAndSummonerOutfits.MissionHatCloak, player:getStorageValue(Storage.Quest.U7_8.MageAndSummonerOutfits.MissionHatCloak) + 1)
		if not last then
