...
addTravelKeyword("isle of the kings", 10, { x = 32190, y = 31957, z = 6 })


-- Basic
keywordHandler:addKeyword({ "passage" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "Where do you want to go today? We serve the routes to {isle of the kings}.",
})
keywordHandler:addKeyword({ "job" }, StdModule.say, {
	npcHandler = npcHandler,
	text = "We are ferrymen. We transport goods and passengers to the isle of the kings.",
})
...
npcHandler:setMessage(MESSAGE_GREET, "Ahoi, young man |PLAYERNAME|. If you need a {passage}, let me know.")
