local teleportPosition = Position(32752, 33473, 8)
...
function teleportEvent.onStepIn(creature, item, position, fromPosition)
    ...
    if item.uid == 53201 and item.itemid == 436 then
...
teleportEvent:uid(53201) -- Registra o evento para o UID específico
