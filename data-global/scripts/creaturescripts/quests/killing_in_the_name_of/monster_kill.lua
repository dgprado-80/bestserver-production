...
function deathEvent.onDeath(creature, _corpse, _lastHitKiller, mostDamageKiller)
	...
	onDeathForParty(creature, mostDamageKiller, function(creature, player)
		...
		-- Minotaurs
		killCheck(player, targetName, Storage.KillingInTheNameOf.BudrikMinos, 0, tasks.Budrik[1].creatures, nil, Storage.Quest.U8_5.KillingInTheNameOf.AltKillCount.MinotaurCount)
