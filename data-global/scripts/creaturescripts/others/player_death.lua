...
function playerDeath.onDeath(player, corpse, killer, mostDamageKiller, unjustified, mostDamageUnjustified)
    -- Remover o jogador da party ao morrer
    ...
    -- Registro da morte do jogador no banco de dados
    ...
    -- Webhook para anunciar a morte do jogador
    ...
    -- Código para registrar guild war (sem mudanças)
    if byPlayer == 1 then
