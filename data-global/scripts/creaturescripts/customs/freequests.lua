...
local questTable = {
    ...
    { storage = 42730, storageValue = 1 },
	
	

	
	{ storage = Storage.Quest.U11_80.TheSecretLibrary.MoTA.Questline, storageValue = 2 },
	{ storage = Storage.Quest.U11_80.TheSecretLibrary.MoTA.LeverPermission, storageValue = 1 },
	{ storage = Storage.Quest.U11_80.TheSecretLibrary.MoTA.FinalBasin, storageValue = 1 },
	{ storage = Storage.Quest.U11_80.TheSecretLibrary.MoTA.SkullSample, storageValue = 1 },
	
	
    { storage = Storage.Quest.U7_2.TheQueenOfTheBanshees.BansheeDoor, storageValue = 1 },
	{ storage = Storage.Quest.U7_2.TheQueenOfTheBanshees.FirstSealDoor, storageValue = 1 },
	{ storage = Storage.Quest.U7_2.TheQueenOfTheBanshees.SecondSealDoor, storageValue = 1 },
	{ storage = Storage.Quest.U7_2.TheQueenOfTheBanshees.ThirdSealDoor, storageValue = 1 },
	{ storage = Storage.Quest.U7_2.TheQueenOfTheBanshees.FourthSealDoor, storageValue = 1 },
	{ storage = Storage.Quest.U7_2.TheQueenOfTheBanshees.FifthSealDoor, storageValue = 1 },
	{ storage = Storage.Quest.U7_2.TheQueenOfTheBanshees.SixthSealDoor, storageValue = 1 },
	{ storage = Storage.Quest.U7_2.TheQueenOfTheBanshees.LastSealDoor, storageValue = 1 },
